...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi CursorLine ctermbg=201 ctermfg=233 cterm=NONE guibg=#011d4d gui=NONE
    ...
    hi Keyword ctermbg=NONE ctermfg=201 cterm=bold guibg=NONE guifg=#00ff00 gui=bold
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi Keyword ctermbg=NONE ctermfg=green cterm=bold
